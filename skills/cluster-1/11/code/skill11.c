//John Kircher 09/19/2020
//Attributions go to I2c Display program from class site
//Attributions go to ESP32 Timer guide from the class site
//Attributions to Sam K. for some guidance on task functions and timer scales
...
static void task_1(){
    while (1)
    {
        ...
        if (start == 1){
            displaybuffer[0] = alphafonttable[(int)(counter/10)];
            displaybuffer[1] = alphafonttable[(int)(counter%10)];
            displaybuffer[2] = 0b0000000000000000;
            displaybuffer[3] = 0b0000000000000000;
            i2c_cmd_handle_t cmd4 = i2c_cmd_link_create();
            i2c_master_start(cmd4);
